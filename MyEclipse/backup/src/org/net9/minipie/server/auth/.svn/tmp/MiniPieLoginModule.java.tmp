...
>>>>>>> .r190
	...
	private MiniPieUserPrincipal userIdPrincipal;
...
<<<<<<< .mine
		...
		userId = new UserAuth(username,new String(password)).islegalUser();
		if (userId != -1){
=======
...
>>>>>>> .r190
	...
	public boolean commit() throws LoginException {
		if (succeeded == false) {
			...
			userIdPrincipal = new MiniPieUserPrincipal(""+userId);
