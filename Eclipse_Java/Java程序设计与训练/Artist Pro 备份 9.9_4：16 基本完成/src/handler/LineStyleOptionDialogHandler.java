		...
		public void actionPerformed(ActionEvent e){
			if(dialog.style1.isSelected()){
				...
				if(DrawHandler.currentSelectedShapePro!=null&&DrawHandler.currentSelectedShapePro.selected==true){
					...
					DrawHandler.currentSelectedShapePro.stroke=new BasStroke(frame.lineWidthChooserSlider.getValue(),continuum,"Continuum");
					...
					frame.currentPaintProperty.currentStroke=new BasStroke(frame.lineWidthChooserSlider.getValue(),continuum,"Continuum");
					frame.lineStyleIndicator2.setText("Continuum");
					frame.previewCanvas.repaint();
					dialog.setVisible(false);
				}
				...
				if(DrawHandler.currentSelectedShapePro!=null&&DrawHandler.currentSelectedShapePro.selected==true){
					frame.backShapeProArrayArray.add(CopyShapeProArray.copy(frame.shapeProArray));
					DrawHandler.currentSelectedShapePro.stroke=new BasStroke(frame.lineWidthChooserSlider.getValue(),dash,"Dash");
					...
					frame.currentPaintProperty.currentStroke=new BasStroke(frame.lineWidthChooserSlider.getValue(),dash,"Dash");
					frame.lineStyleIndicator2.setText("Dash");
					frame.previewCanvas.repaint();
					dialog.setVisible(false);
				}
				...
				if(DrawHandler.currentSelectedShapePro!=null&&DrawHandler.currentSelectedShapePro.selected==true){
					frame.backShapeProArrayArray.add(CopyShapeProArray.copy(frame.shapeProArray));
					DrawHandler.currentSelectedShapePro.stroke=new BasStroke(frame.lineWidthChooserSlider.getValue(),dash_dot,"Dash-Dot");
					...
					frame.currentPaintProperty.currentStroke=new BasStroke(frame.lineWidthChooserSlider.getValue(),dash_dot,"Dash-Dot");
					frame.lineStyleIndicator2.setText("Dash-Dot");
					frame.previewCanvas.repaint();
					dialog.setVisible(false);
				}
				...
				if(DrawHandler.currentSelectedShapePro!=null&&DrawHandler.currentSelectedShapePro.selected==true){
					frame.backShapeProArrayArray.add(CopyShapeProArray.copy(frame.shapeProArray));
					DrawHandler.currentSelectedShapePro.stroke=new BasStroke(frame.lineWidthChooserSlider.getValue(),dot,"Dot");
					...
					frame.currentPaintProperty.currentStroke=new BasStroke(frame.lineWidthChooserSlider.getValue(),dot,"Dot");
					frame.lineStyleIndicator2.setText("Dot");
					frame.previewCanvas.repaint();
					dialog.setVisible(false);
				}
