...
public class MainFrame extends JFrame{
	...
	//faceIcon
	public ImageIcon smileIcon=new ImageIcon("./src/images/smile.gif");
	public ImageIcon cryIcon=new ImageIcon("./src/images/cry.gif");
	public ImageIcon faintIcon=new ImageIcon("./src/images/faint.gif");
	public ImageIcon byeIcon=new ImageIcon("./src/images/bye.gif");
	public ImageIcon angryIcon=new ImageIcon("./src/images/angry.gif");
	public ImageIcon bsIcon=new ImageIcon("./src/images/bs.gif");
	public ImageIcon omgIcon=new ImageIcon("./src/images/omg.gif");
	public ImageIcon hahaIcon=new ImageIcon("./src/images/haha.gif");
