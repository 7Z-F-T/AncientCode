...
public class Translater {
	...
	public static Translater translate(Program tree) {
	...
	public void genJump(Label dst) {
		append(Tac.genJump(dst));
	}

	public void genJZero(Temp cond, Label dst) {
		append(Tac.genJZero(cond, dst));
	}
