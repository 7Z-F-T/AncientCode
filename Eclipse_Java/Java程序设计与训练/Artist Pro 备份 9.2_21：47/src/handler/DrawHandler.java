		...
		switch(frame.currentFunction){
		    ...
		    case Function.ROTATE:
		    	if(currentSelectedShapePro!=null&&currentSelectedShapePro.selected==true){
		    		...
		    		currentSelectedShapePro.rotatedVecY+=y/10;
		    		canvas.repaint();
		    		lastX=e.getX();
		    		lastY=e.getY();
		    		break;
		    ...
		    case Function.SCALE:
		    	if(currentSelectedShapePro!=null&&currentSelectedShapePro.selected==true){
		    		...
		    		if(tempX>currentSelectedShapePro.getCenterPoint().x)
		    			currentSelectedShapePro.scaledFactorX+=x/120;
		    		else
		    			currentSelectedShapePro.scaledFactorX-=x/120;
		    		if(tempY>currentSelectedShapePro.getCenterPoint().y)
		    			currentSelectedShapePro.scaledFactorY+=y/120;
		    		else
		    			currentSelectedShapePro.scaledFactorY-=y/120;
		    		lastX=e.getX();
		    		lastY=e.getY();
		    ...
		    case Function.SHEAR:
		    	if(currentSelectedShapePro!=null&&currentSelectedShapePro.selected==true){
		    		...
		    		double y=e.getY()-lastY;
		    		if(tempX>currentSelectedShapePro.getCenterPoint().x)
		    			currentSelectedShapePro.shearedFactorX+=x/120;
		    		else
		    			currentSelectedShapePro.shearedFactorX-=x/120;
		    		if(tempY>currentSelectedShapePro.getCenterPoint().y)
		    			currentSelectedShapePro.shearedFactorY+=y/120;
		    		else
		    			currentSelectedShapePro.shearedFactorY-=y/120;
		    		lastX=e.getX();
		    		lastY=e.getY();
