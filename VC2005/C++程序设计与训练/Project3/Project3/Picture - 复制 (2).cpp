...
void Picture::display(ostream& out, int x, int y,char c,char s,char t) const
{p->display(out, x, y);}
...
void String_Pic::display(ostream& out, int x, int y,char c,char s,char t) const
{
	int start = 0;
	if (x >=0 && x < height())
	{
...
void Frame_Pic::display(ostream& out, int x, int y,char c,char s,char t) const
{
	if(x==0)//第一行
	{
...
void VCat_Pic::display(ostream& out, int x,int y,char c,char s,char t) const
{
...
void HCat_Pic::display(ostream& out, int x,int y,char c,char s,char t) const
{
...
//Reframe_Pic
Reframe_Pic::Reframe_Pic(const Picture& pic):pic(pic){}
void Reframe_Pic::display(ostream& out, int x,int y,char c,char s,char t) const
{
	pic.display(out,x,y,'%','&','@');
}
...
Picture reframe(const Picture &pic)
{
	return new Reframe_Pic(pic);
}
