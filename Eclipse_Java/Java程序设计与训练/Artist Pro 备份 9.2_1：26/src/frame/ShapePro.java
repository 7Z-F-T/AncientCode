...
public class ShapePro {
	...
	public ShapePro(){}
	public ShapePro(Shape s,BasicStroke stk,Color lc, int fType, Color fc, GradientPaint gfc,int type,boolean sel,boolean rot,double rvx,double rvy,boolean sca,double sfx,double sfy){
		shape=s;
		stroke=stk;
		lineColor=lc;
		fillType=fType;
